...
const ProfileScreen = () => {
  ...
  const store_data = useSelector(state=> state?.parsalPartner?.logindriverdetails)
  useEffect(() => {
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <VehicleProfileCard isOnline={store_data?.working_status} screen={''} />
        <PartnerAddressCard
          profile={partneData}
