...
const VehicleVerificationCard = ({verifyVisibleCard,setVerifyVisibleCard}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.UserDetailMainContainer}>
        <Text style={styles.cardTitle}>Up-32-D-2222, Ahmad</Text>
    ...
    <View style={{backgroundColor:Colors.homeBackground}}>
        <View style={styles.statusDetail}>
          <Text style={styles.statusText}>
            There were some issues with the following document. Please re-upload the documents to verify again.
          </Text>
        </View>
        ...
        <View style={styles.adressContainer}>
          <ImagePickerComponent
            ...
            // Add any props for the ImagePickerComponent
            useCamera={false}
          />
        </View>
        </View>
        ...
        <TouchableOpacity style={styles.verifyButton} onPress={handleVerifyAgain}>
