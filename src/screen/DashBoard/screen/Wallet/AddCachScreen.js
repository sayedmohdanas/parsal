...
//   const {screenName, remaningBalance} = route?.params || {
//     screenName: 'Add Cash',
//     remaningBalance: 0,
//   };  console.log(remaningBalance,'remaing--balance')
...
//     setbalance(amount);
//     // Check if entered amount exceeds the remaining balance
//     if (Number(amount) > remaningBalance) {
